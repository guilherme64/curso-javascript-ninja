(function() {
    ...
    */
    ...
    //text = text.replace(/Manuel Marques de Sousa/, 'Guilherme Melo');
    console.log(text.replace(/Manuel Marques de Sousa/, 'Guilherme Melo'));
    ...
    */
    ...
    //text = text.replace(/brasileiro/, 'maranhense');
    ...
    */
    ...
    console.log(text.replace(/[0123456789]/g, '-'));
    ...
    */
    ...
    var ano = ['janeiro', 'fevereiro', 'março', 'abril', 'maio', 'junho',
    ...
    for (var i = 0; i < ano.length; i++) {
        console.log(
            'O mês de ' + ano[i] + ' é representado pelo número ' + getMonthNumber(ano[i]) + '.');
    }
    /*
    ...
    */
    ...
    function replaceDate(str) {
       var newStr = str.split(' de ');
       newStr[1] = getMonthNumber(newStr[1]);
       newStr = newStr.join('/');
       console.log(newStr); 
    }
    text.match(regexDate).map(function(cur){
        return replaceDate(cur);
    });
})();
